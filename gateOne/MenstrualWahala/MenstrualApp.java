...
import java.time.format.DateTimeFormatter;
	...
	public class menstrualApp{
		...
		System.out.println("WELCOME TO AKWAUGO MENSTRUATION CALCULATOR" + "\nNB : CACULATIONS MIGHT NOT BE ACCURATE");
		...
		System.out.println("The Predicted date for your next period is " + nextStartdate + " to " + nextEnddate);
			...
			LocalDate ovulationStartdate = lastStartDateEntered.plusDays(cycleLength/2);
